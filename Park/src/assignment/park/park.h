...
void gazeboDraw(Shader shader, unsigned int gazeboFrameDiff, unsigned int gazeboRoofDiff, unsigned int pavingDiff, unsigned int highSpec, unsigned int mildSpec, unsigned int noSpec);
